<header class="bg-lime-900 sticky top-0" style="z-index: 900" x-data="dropdown()">
    <div class="container flex items-center h-20 justify-between md:justify-start">
        ...
        <a  :class="{'bg-opacity-100 text-lime-600' : open}"
            x-on:click="show()"
            class="flex flex-col items-center justify-center px-6 mr-6 md:px-4 bg-white bg-opacity-25 text-white cursor-pointer font-semibold h-full">
    ...
    <nav id="navigation-menu" 
            ...
            <div
                ...
                <ul class="bg-white">
                    @foreach ($categories as $category)
                        <li class="navigation-link text-trueGray-500 hover:bg-lime-900 hover:text-white">
        ...
        <div class="bg-white h-full overflow-y-auto">
            ...
            <ul>
                @foreach ($categories as $category)
                    <li class="text-trueGray-500 hover:bg-lime-600 hover:text-white">
                        <a href="{{route('categories.show', $category)}}" class="py-2 px-4 text-sm flex items-center">
                            {{$category->name}}
                        </a>
                    </li>
            ...
            @else
                <a href="{{ route('login') }}" class="py-2 px-4 text-sm flex items-center text-trueGray-500 hover:bg-lime-600 hover:text-white">
