<div class="flex-1 relative" x-data>
    ...
    <form action="{{ route('search') }}" autocomplete="off">
        ...
        <!-- <button class="absolute top-0 right-0 w-12 h-full bg-lime-600 flex items-center justify-center rounded-r-md">
            <x-search size="35" color="white" />
        </button> -->

    </form> 

    <div class="w-full mt-1 hidden" :class="{ 'hidden' : !$wire.open }" @click.away="$wire.open = false">
