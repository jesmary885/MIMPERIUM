...
@section('content')
    <div class="container py-2">
        ...
        <section class="grid grid-cols-3 gap-6 text-white">
            <a href="{{ route('orders.index') . "?status=1" }}" class="bg-red-500 bg-opacity-75 rounded-lg px-12 pt-8 pb-4 hover:text-gray-200">
            ...
            <a href="{{ route('orders.index') . "?status=2" }}" class="bg-blue-500 bg-opacity-75 rounded-lg px-12 pt-8 pb-4 hover:text-gray-200">
                <p class="text-center text-2xl">
                    {{$recibido}}
                </p>
            ...
            <a href="{{ route('orders.index') . "?status=3" }}" class="bg-green-500 bg-opacity-75 rounded-lg px-12 pt-8 pb-4 hover:text-gray-200">
                <p class="text-center text-2xl">
                    {{$anulado}}
                </p>
