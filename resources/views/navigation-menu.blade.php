        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <!-- <x-jet-nav-link href="{{route('admin.rangos')}}" :active="request()->routeIs('admin.rangos')">
                        Rangos
                    </x-jet-nav-link> -->

                    <x-jet-nav-link href="{{route('admin.my_payments.index')}}" :active="request()->routeIs('admin.my_payments.index')">
                        Mis Pagos
                    </x-jet-nav-link>

                    <x-jet-nav-link href="{{route('admin.genealogia_residual')}}" :active="request()->routeIs('admin.genealogia_residual')">
                        Mi Genealogía residual
                    </x-jet-nav-link>

                    <x-jet-nav-link href="{{route('admin.my_points.index')}}" :active="request()->routeIs('admin.my_points.index')">
                        Mis puntos
                    </x-jet-nav-link>
